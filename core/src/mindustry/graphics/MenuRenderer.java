...
public class MenuRenderer implements Disposable{
    ...
    private UnitType flyerType = Structs.select(UnitTypes.quad, UnitTypes.corvus, UnitTypes.toxopid, UnitTypes.mega, UnitTypes.gamma);
    ...
    private void generate(){
        ...
        Block[] selected3 = Structs.select (
            ...
            new Block[]{Blocks.stone, Blocks.coreNucleus}
        );
