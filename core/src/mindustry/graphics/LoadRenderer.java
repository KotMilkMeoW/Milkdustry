...
public class LoadRenderer implements Disposable {
	...
	private static final Color color = new Color(Pal.darkMetal).lerp(Color.black, 0.5f);	private static final Color colorRed = Pal.breakInvalid.cpy().lerp(Color.black, 0.3f);
